      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown messages-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-envelope"></i> <span class="label label-success">4</span> </a>
          <ul class="dropdown-menu">
            <li class="header">Yeni 4 mesajınız var.</li>
            <li> 
              ...
              <ul class="menu">
                <li><!-- start message --> 
                  ...
                  <h4> malibahar@ogrenci.selcuk.edu.tr</h4>
                  <p>Yarına yapılacak ödevleri biliyor musun? Hastaydım gelemedim.</p>
                  </a> 

                  <a href="#">
                  <div class="pull-left"> <img src="img/avatar04.png" class="img-circle" alt="User Image"/> </div>
                  <h4> mustafatalhaavcu@ogrenci.selcuk.edu.tr</h4>
                  <p>Yarına yapılacak ödevleri biliyor musun? Hastaydım gelemedim.</p>
                  </a> 

                  <a href="#">
                  <div class="pull-left"> <img src="img/avatar2.png" class="img-circle" alt="User Image"/> </div>
                  <h4> mehmetrizakucukosmanoglu@ogrenci.selcuk.edu.tr</h4>
                  <p>Yarına yapılacak ödevleri biliyor musun? Hastaydım gelemedim.</p>
                  </a> 
        ...
        <li class="dropdown tasks-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-th-list"></i> <span class="label label-danger">9</span> </a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span>Agah Toruk <i class="caret"></i></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header bg-light-blue"> <img src="img/avatar3.png" class="img-circle" alt="User Image" />
              <p> Agah Toruk <small>Bilgisayar Programcılığı</small> <small>Teknik Bilimler Meslek Yüksekokulu</small> </p>
            </li>
            <!-- Menu Body-->
            <li class="user-body">
              <div class="col-xs-6 text-center"> <a href="#"><i class="fa fa-user"></i> Kimlik Bilgilerim</a> </div>
              <div class="col-xs-6 text-center"> <a href="#"><i class="fa fa-lock"></i> Şifre Değişikliği</a> </div>
            </li>
            <!-- Menu Footer-->
            <li class="user-footer">
              <div class="pull-right"> <a href="#" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> <small>Çıkış Yap</small></a> </div>
            </li>
          </ul>
        </li>
      </ul>
